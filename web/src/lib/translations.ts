...
export const TRANSLATIONS = {
  ja: {
    ...
    adjustedCheckoutNotice: '前回のチェックアウト記録が確認できなかったため、一律【30分】として利用時間を記録しました。正しくランキングに反映させるため、お帰りの際は忘れずにチェックアウトをお願いします。',
    ...
    statusOnline: 'オンライン',
    statusOffline: 'オフライン',
    statusUnsent: '未同期ログ: {count}件',
    btnRankings: 'ランキング / 統計',
    rankingsTitle: 'ランキング / 統計',
    monthlyRanking: '月間利用時間ランキング',
    streakRanking: '連続利用日数ランキング',
    noRankingData: 'ランキングデータはまだありません。',
    minutesUnit: '{minutes}分',
    daysUnit: '{days}日',
    usageDuration: '滞在時間: {minutes}分',
    monthlyUsageSummary: '今月の利用時間: {minutes}分',
    streakSummary: '連続{days}日目のトレーニング達成！',
  ...
  en: {
    ...
    messagesOfSupport:"Let's give today's training our best, too!",
    ...
    adjustedCheckoutNotice: 'The previous check-out record could not be confirmed, so your usage time was recorded as a flat 30 minutes. Please remember to check out on your way out so it is reflected correctly in the rankings.',
    ...
    statusUnsent: 'Unsynced logs: {count}',
    btnRankings: 'Rankings / Stats',
    rankingsTitle: 'Rankings / Stats',
    monthlyRanking: 'Monthly usage time',
    streakRanking: 'Training streaks',
    noRankingData: 'No ranking data yet.',
    minutesUnit: '{minutes} min',
    daysUnit: '{days} days',
    usageDuration: 'Stay: {minutes} min',
    monthlyUsageSummary: 'This month: {minutes} min',
    streakSummary: '{days}-day training streak!',

...
export const TRANSLATIONS = {
  ja: {
    ...
    adjustedCheckoutNotice: '前回のチェックアウト記録が確認できなかったため、利用時間を30分として記録しました。正しくランキングに反映させるため、お帰りの際は忘れずにチェックアウトをお願いします。',
    registerErr: '登録エラーが発生しました。インターネット接続およびブラウザの設定をご確認ください。',
    scanReadErr: '学籍番号を読み取れませんでした。もう一度お試しください。',
    raspiConnectionErr: 'カメラへの接続に失敗しました。WiFi接続状況を確認してください。',
    offlineReg: 'オフライン登録',
    offlineSave: 'オフライン保存',
    detectLabel: '検出',
    btnRetry: '再試行',
  ...
  en: {
    ...
    raspiConnectionErr: 'Could not connect to the Camera. Please check the Wi-Fi connection.',

...
<!-- 変更履歴
  2026-06-25 更新:
  - §1 システム構成図: マスタテーブル（departments_master / department_classes）ノードを追加
  - §2 データフロー: 6. チェックアウト登録フロー を新規追加
-->
...
graph TB
    ...
    subgraph Vercel [クラウドホスティング 確定]
        ...
        CronJob[Vercel Cron<br/>自動チェックアウト 15時間]
    ...
    AdminUI <-->|3. データ取得 / CSVエクスポート / マスタ管理| APIRoute
```
